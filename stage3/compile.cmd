...
cl /Zi /GS- /GR- /W4 /WX /Os /Ox /I. /FAs /D_HAS_EXCEPTIONS=0 stage3.cpp attos\rt.cpp attos\cpu.cpp attos\mem.cpp attos\mm.cpp attos\isr.cpp attos\pci.cpp attos\ata.cpp attos\pe.cpp attos\out_stream.cpp attos\vga\text_screen.cpp isr_common.obj crt.obj /link /debug /nodefaultlib /entry:stage3_entry /subsystem:NATIVE /FILEALIGN:4096 /BASE:0xFFFFFFFFFF000000 /DYNAMICBASE:NO /HIGHENTROPYVA:NO /OPT:REF /OPT:ICF /SAFESEH:NO /merge:.rdata=.data /merge:.text=.data /merge:.pdata=.data /merge:.xdata:=.data /merge:.CRT=.bss /map || (popd & exit /b 1)
