@pushd %~dp0
cl /GS- /GR- /W4 /WX /Os /I. /FAs /D_HAS_EXCEPTIONS=0 stage3.cpp attos\rt.cpp attos\util.cpp attos\mem.cpp attos\mm.cpp attos\out_stream.cpp attos\vga\text_screen.cpp /link /nodefaultlib /entry:stage3_entry /subsystem:NATIVE /FILEALIGN:4096 /BASE:0xFFFFFFFFFF000000 /DYNAMICBASE:NO /HIGHENTROPYVA:NO /OPT:REF /OPT:ICF /SAFESEH:NO  /merge:.rdata=.data /merge:.text=.data /merge:.pdata=.data /merge:.CRT=.bss || (popd & exit /b 1)
